...
<Lottie animation="classicalVsRobust" height={220} width={320} caption="Just as classical methods fail with outliers, normal approximations fail with rare events—exact methods are essential." />
...
<Lottie animation="skewTuning" height={220} width={320} caption="Adjusting sample size is like tuning—too small and you miss defects, too large and you waste resources. Find the sweet spot!" />
...
<div style={{textAlign: 'center', margin: '3rem 0', padding: '2rem', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '15px', color: 'white'}}>
  ...
  <h3 style={{margin: '1rem 0', color: 'white'}}>Day 14 Complete! 🎉</h3>
  <p style={{margin: 0, fontSize: '1.1rem', opacity: 0.9}}>*This is Day 14 of my 30-day challenge documenting my Data Science journey at Oracle! Stay tuned for more insights and mathematical foundations of data science. 🚀*</p>
  <div style={{marginTop: '1.5rem'}}>
    <p style={{margin: 0, fontSize: '0.9rem', opacity: 0.9}}>Next: Day 15 - Power Analysis for Means (t-tests), where we'll figure out sample sizes for comparing group averages - the most common experimental design question! 📊🔬</p>
  </div>
</div>
