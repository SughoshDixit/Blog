...
<Lottie animation="analyticsPulse" height={240} width={340} caption="Imputation and coercion choices directly impact statistical measures and threshold calibration—choose wisely." />
...
<Lottie animation="breakdownFortress" height={220} width={320} caption="Different imputation methods shift distributions in different ways—understand the trade-offs." />
