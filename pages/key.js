                  ...
                  {termsByCategory[category].map((item, index) => {
                    ...
                    return (
                      <div 
                        key={index} 
                        id={termId}
                        className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg hover:shadow-md transition-shadow scroll-mt-24 group"
                      >
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <a 
                            href={`#${termId}`} 
                            className="text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity hover:text-redwood-500"
                            title="Direct link to this term"
                          >
